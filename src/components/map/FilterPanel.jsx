...
export const FilterPanel = ({ onFilterChange, activeFilters }) => {
  ...
  return (
    <div
      className={`fixed left-4 top-24 z-40 transition-transform duration-500 ${
            ...
            {filterCategories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-nav tracking-wide flex-1 text-left ${
          ...
          {activeFilters.length > 0 && (
            <div className="pt-3 border-t border-temple-gold/30">
              <p className="text-sm text-parchment/70 font-body text-center">
                <span className="text-soft-gold font-bold">{activeFilters.length}</span> filter

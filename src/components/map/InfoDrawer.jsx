            ...
            <div className="p-6 space-y-6">
              ...
              <section className="space-y-3 border-t border-temple-gold/20 pt-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {["Aryavarta", "Dakshinapatha", "Kalinga", "Avanti", "Gandhara", "Magadha"].map(
                    (kingdom) => (
                      <div
                        key={kingdom}
                        className="bg-card/50 border border-temple-gold/20 rounded px-3 py-2"
                      >
              ...
              <section className="space-y-3 border-t border-temple-gold/20 pt-4">
                ...
                <div className="space-y-2 text-sm">
                  {[
                    ...
                    <div
                      key={river.name}
                      className="bg-card/50 border border-temple-gold/20 rounded p-3"
                    >
              ...
              <div className="pt-6 border-t-2 border-temple-gold/30">
                <div className="flex items-center justify-center gap-4 text-2xl opacity-60">
                  ...
                  <span className="animate-breathe" style={{ animationDelay: "1s" }}>
                    🪷
                  </span>
                  <span className="animate-breathe" style={{ animationDelay: "2s" }}>
                    🔱
                  </span>
                </div>
              </div>
